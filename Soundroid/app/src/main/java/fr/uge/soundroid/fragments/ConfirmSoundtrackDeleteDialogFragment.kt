...
class ConfirmSoundtrackDeleteDialogFragment(val soundtrack: Soundtrack) : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        builder.setMessage(getString(R.string.remove_soundtrack_dialog_message, soundtrack.title))
