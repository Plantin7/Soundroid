...
class CreatePlaylistDialogFragment(val soundtrack: Soundtrack) : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        builder.setMessage(getString(R.string.create_playlist_dialog_message, soundtrack.title))
